	<!-- Main Navigation menu for Desktop -->
			<nav class="mainNav">
		      ...
		      <li>
		      	<a href="https://eviebowerman.com/">Graphics</a>
		      </li>
		      <li>
		      	<a href="https://eviebowerman.com/photos">Photography</a>
		      </li>
		      <li>
		      	<a href="https://eviebowerman.com/about">About</a>
		      </li>
		      <li>
		      	<a href="https://eviebowerman.com/contact">Contact</a>
		      </li>
	    	</menu>
    	</nav>
